...
## ABOUT
- UCOD (/ˈjuːkɒd/, UI Class Operation Diagram) is a modeling notation based on class diagrams and screen flow diagrams, designed to visualize how users use a product.
