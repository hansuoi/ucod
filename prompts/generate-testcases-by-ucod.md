...
- `(Table)` columns (indented children): treat as per-row context; design row-level steps and assertions, and consider table-level cases (empty/single/many rows, pagination, filtering)
